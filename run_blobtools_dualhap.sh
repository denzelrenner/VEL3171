#!/bin/bash
#SBATCH -J run_blobtools_dualhap
...
output_dir=~/LyrenosaPangenome/DiploidYahs_VEL3171/VEL3171.hifi_reads/s3_quality_control/Yahs/VEL3171.hifi_reads.hic.hap_comb/s3_quality_control/Blobtools
assembly=~/LyrenosaPangenome/DiploidYahs_VEL3171/VEL3171.hifi_reads/s3_quality_control/Yahs/VEL3171.hifi_reads.hic.hap_comb/s1_run_yahs_read_qc/yahs.out_scaffolds_final.fa
...
minimap_bam=VEL3171.dualhap.vs.reads.bam
...
blobdir_outname=VEL3171.bp.dualhap
