...
blob_fasta=~/LyrenosaPangenome/DiploidYahs_VEL3171/VEL3171.hifi_reads/s3_quality_control/Yahs/VEL3171.hifi_reads.hic.hap1/s3_quality_control/Blobtools/viewer/FilteredScaffolds/yahs.out_scaffolds_final.wquery.fa
nhap=2
...
for file in $dirofbams/VEL*.bam; do
    ...
    if [ -f $file ]; then
        ...
        GfaPrefix=VEL3171.hap1.blobtools.filt.scaffolds_final.wquery
