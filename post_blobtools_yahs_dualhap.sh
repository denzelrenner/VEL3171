#!/bin/bash
#SBATCH -J running_pretextmap_post_blobtools_VEL3171_hap1
...
blob_fasta=~/LyrenosaPangenome/DiploidYahs_VEL3171/VEL3171.hifi_reads/s3_quality_control/Yahs/VEL3171.hifi_reads.hic.hap_comb/s3_quality_control/Blobtools/viewer/FilteredScaffolds/yahs.out_scaffolds_final.wquery.fa
nhap=2
...
for file in $dirofbams/VEL*.bam; do
    ...
    if [ -f $file ]; then
        ...
        GfaPrefix=VEL3171.hap_comb.blobtools.filt.scaffolds_final.wquery
